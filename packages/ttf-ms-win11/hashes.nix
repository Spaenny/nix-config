...
let
  splitNewlines =
    string: builtins.filter (x: builtins.isString x && x != "") (builtins.split "\n" string);
in
{
  fonts.base = [
    ########################################################################################################
  ...
  sha256Hashes = splitNewlines ''
    ...
    4e6ebd5a1bab4330be223b7d21624bc55a46a38a3a760e1af87d0388f49176f4
